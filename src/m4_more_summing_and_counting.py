...
def run_test_factorial():
    ...
    # Test 5:
    answer_from_hand = 120
    answer_from_my_code = factorial(5)
    print('Test 5 expected (from by-hand):', answer_from_hand)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 3
    answer = count_cosines_from(3,8,.25)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 1
    answer = count_cosines_from(2,9,.8)
    ...
    # Test 5:
    expected = 3
    answer = count_cosines_from(3,9,.27)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(2,9,.29)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 1.217  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(3, 8)
